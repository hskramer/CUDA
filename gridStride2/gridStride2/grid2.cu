...
// I started with the SAXPY example then slowly added more and new functionality over serveral iterations as I began to understand them this #2 unified memory
...
int main(void)
{
	...
	// and shows a simple method for handling arrays that are much larger than the maximum number of threads used or available when using dim3
